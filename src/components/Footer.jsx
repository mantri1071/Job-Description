...
const Footer = () => {
  return (
    <footer className="w-full bg-sky-50/80 backdrop-blur-lg text-black mt-1 pt-8 pb-4">
      <motion.div
      ...
      >
        <div className="text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-6 text-gray-700">
            <a
          ...
          <div className="flex justify-center items-center gap-2 mb-8 text-gray-700 mt-1">
            <MapPin size={18} />
